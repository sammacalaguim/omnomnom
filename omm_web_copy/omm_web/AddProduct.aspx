        ...
        <div class="container">
            <div class="row block-9">
                ...
                <div class="col-md-6 pr-md-5">
                    ...
                    <div class="form-group row">
                        <label for="fldSubtitle" class="col-sm-3 col-form-label">Subtitle<font color="red">*</font></label>
                        <div class="col-sm-8">
                            <asp:TextBox CssClass="form-control" runat="server" ID="fldSubtitle"></asp:TextBox>
                        </div>
                        <div class="col-sm-1">
                            <asp:RequiredFieldValidator ID="rfvSubtitle"
                                runat="server" ControlToValidate="fldSubtitle"
                                ErrorMessage="!" ForeColor="Red" Font-Bold="true" ValidationGroup='valGroup'>
                            </asp:RequiredFieldValidator>
                        </div>
                    </div>
